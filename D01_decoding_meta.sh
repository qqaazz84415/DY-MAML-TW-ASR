...
# test data
# dir_data_test=$dir_data_base/test_formosa
...
dir_tdnn=$dir_target_tdnn/tdnn_chain_meta2
dir_tdnn_hmm=$dir_target_base/graph_tdnn_hmm_meta

# result
dt=$(date '+%Y-%m-%d_%H-%M-%S');
dir_result=$dir_result_base/result_${dt}_meta
