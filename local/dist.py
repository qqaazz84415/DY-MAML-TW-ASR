...
def main():
    ...
    if(os.path.exists(lastdistpath + "/dist.txt")):
        for lang in langs:
            ...
            # lpdiffSup = (logprobtmps[2][0] - logprobtmps[0][0]) + (logprobtmps[2][1] - logprobtmps[0][1]) + (logprobtmps[5][0] - logprobtmps[3][0]) + (logprobtmps[5][1] - logprobtmps[3][1]) # diff of starting loss and final loss
            # lpdiffQue = (logprobtmpq[2][0] - logprobtmpq[0][0]) + (logprobtmpq[2][1] - logprobtmpq[0][1]) + (logprobtmpq[5][0] - logprobtmpq[3][0]) + (logprobtmpq[5][1] - logprobtmpq[3][1]) # diff of starting loss and final loss
